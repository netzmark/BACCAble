#include "lowConsume.h"
	...
	void lowConsume_init(void){
		...
		HAL_GPIO_Init(CHIP_LOW_CONSUME_Port, &GPIO_InitStruct);

		GPIO_InitStruct.Pin = CHIP_LOW_CONSUME2_Pin;	// LOW_CONSUME2 is for UCAN
		GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
		HAL_GPIO_Init(CHIP_LOW_CONSUME2_Port, &GPIO_InitStruct);
		...
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		HAL_GPIO_Init(CAN_LOW_CONSUME_Port, &GPIO_InitStruct);

		GPIO_InitStruct.Pin = CAN_LOW_CONSUME2_Pin;		// LOW_CONSUME2 is for UCAN
		GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		HAL_GPIO_Init(CAN_LOW_CONSUME2_Port, &GPIO_InitStruct);
		CAN_LOW_CONSUME_Off();
